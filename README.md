...
该分支适配后端`v6`版本 但是没有精力维护了

适用于后端从v5升级到v6 前端可以很大程度上兼容
...
依依-阿里/腾讯/华为云服务器高返, 疯狂的牛子Li, 四海升平(站长推荐https://ku0.com/), 疯狂的骡子Li, 疯狂的鸟哥Li, 疯狂的麦克斯, 消息必须回🤔, 群复读机(末初科技 mochu.tech), 大熊, 張Zcccccy, 等風來再離開, AI主理人, 沪爷托马斯!
